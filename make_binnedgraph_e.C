void make_binnedgraph_e()
{
    ...
    fileBSM_2pi.open("eventrate_e_cmutau_1.0e-27_2M_PI.dat",ios::in);
    fileBSM_3pi5.open("eventrate_e_cmutau_1.0e-27_3M_PI5.dat",ios::in);
    fileBSM_pi.open("eventrate_e_cmutau_1.0e-27_M_PI.dat",ios::in);
    fileBSM_pi5.open("eventrate_e_cmutau_1.0e-27_M_PI5.dat",ios::in);
    ...
    histBSM_2pi->GetXaxis()->SetRangeUser(0,100);
    histBSM_2pi->GetYaxis()->SetRangeUser(0,100);
    //espessura da linha
    ...
    legend->AddEntry(histBSM_2pi, "#phi_{#mu#tau} = 2#pi", "f");//já considera 10^9
    ...
    canvas->SaveAs("eventrate_e_cmutau_1.0e-27_.png");
}
